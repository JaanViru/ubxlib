...
typedef enum {
    ...
    U_CELL_PWR_3GPP_POWER_SAVING_STATE_BLOCKED_BY_MODULE, /**< 3GPP power saving could be
                                                               ...
                                                               or MQTT or HTTP or LWM2M)
                                                               activity on the module is
                                                               blocking it. */
    U_CELL_PWR_3GPP_POWER_SAVING_STATE_ACTIVE,      /**< the cellular protocol stack
                                                         has entered 3GPP power saving. */
 ...
 *                          number is module-specific, please refere to the power
